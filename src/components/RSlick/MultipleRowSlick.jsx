...
const MultipleRowSlick = (props) => {
  ...
  const itemsPerRow = props.arrFilm.length >= 4 ? 4 : props.arrFilm.length;
  const rowsCount = props.arrFilm.length > itemsPerRow ? 2 : 1;
  ...
  return (
    <div className='max-w-7xl mx-auto px-4 relative mt-8'>
      ...
      <button
        ...
        disabled={props.page <= 0 && props.isSearching === false}
      >
        <svg
      ...
      <button
        ...
        disabled={
          props.page >= props.totalPage - 1 && props.isSearching === false
        }
      >
        <svg
          xmlns='http://www.w3.org/2000/svg'
